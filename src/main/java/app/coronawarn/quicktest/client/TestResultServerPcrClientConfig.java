...
import app.coronawarn.quicktest.config.TestResultServerPcrValuesConfig;
import feign.Client;
...
public class TestResultServerPcrClientConfig {

    private final TestResultServerPcrValuesConfig config;
