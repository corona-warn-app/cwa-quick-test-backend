...
public class QuickTestArchiveTest {
    ...
    void constructorTest() {
        ...
        quickTestArchive.setPocInformation("test<br>tss");
        quickTestArchive.setPocUser("pocuser");
        assertEquals("QuickTestArchive(hashedGuid=mkamhvdumyvhxeftazravmyrasozuloaghgluvbfjohpofogkylcnsybubamwnht, "
                        ...
                        " dcc=null, additionalInfo=Hello, groupName=Barmen, pocInformation=test<br>tss," +
                        " pocUser=pocuser)",
